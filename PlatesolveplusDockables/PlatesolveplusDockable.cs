...
namespace Flashy_Ger.NINA.Platesolveplus.PlatesolveplusDockables {
    ...
    public internal class PlatesolveplusDockable : DockableVM, ITelescopeConsumer {
    ...
    public PlatesolveplusDockable(
        ...
        dict.Source = new Uri("Flashy-Ger.NINA.Platesolveplus;component/PlatesolveplusDockables/PlatesolveplusDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
        ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Flashy-Ger.NINA.Platesolveplus_AltitudeSVG"];
