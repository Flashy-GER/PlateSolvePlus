...
namespace Flashy_Ger.NINA.Platesolveplus.PlatesolveplusTestCategory {
    ...
    public PlatesolveplusInstruction() {
        Text = Settings.Default.DefaultNotificationMessage;
    }
    public PlatesolveplusInstruction(PlatesolveplusInstruction copyMe) : this() {
        CopyMetaData(copyMe);
    }
    ...
    public override object Clone() {
        return new PlatesolveplusInstruction(this);
    }
    ...
    public override string ToString() {
        return $"Category: {Category}, Item: {nameof(PlatesolveplusInstruction)}, Text: {Text}";
    }
}
}