...
namespace Flashy_Ger.NINA.Platesolveplus.PlatesolveplusTestCategory {
    ...
    public internal class PlatesolveplusCondition : SequenceCondition {
    /// <summary>
    ...
    public PlatesolveplusCondition() {
        IsTruthy = true;
    }
    ...
    public override object Clone() {
        return new PlatesolveplusCondition() {
            Icon = Icon,
            Name = Name,
            Category = Category,
    ...
    public override string ToString() {
        return $"Category: {Category}, Item: {nameof(PlatesolveplusCondition)}, IsTruthy: {IsTruthy}";
    }
}
}