...
namespace Flashy_Ger.NINA.Platesolveplus.PlatesolveplusTestCategory {
    ...
    public internal class PlatesolveplusTrigger : SequenceTrigger {
    /// <summary>
    ...
    public PlatesolveplusTrigger() {
    }

    public override object Clone() {
        return new PlatesolveplusTrigger() {
            Icon = Icon,
            Name = Name,
            Category = Category,
    ...
    public override string ToString() {
        return $"Category: {Category}, Item: {nameof(PlatesolveplusTrigger)}";
    }
}
}