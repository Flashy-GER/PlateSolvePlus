...
namespace Flashy_Ger.NINA.Platesolveplus.PlatesolveplusDrivers {
    ...
    /// </summary>
    public class PlatesolveplusWeatherDriver : BaseINPC, IWeatherData {
    public PlatesolveplusWeatherDriver(string uniqueId, string deviceId) {
        Id = uniqueId;
        serialNumber = deviceId;
        Name = $"Platesolveplus Weather Data ({deviceId})";
    ...
    public string Category => "Platesolveplus Weather Driver";
