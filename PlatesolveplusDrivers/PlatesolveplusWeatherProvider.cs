...
namespace Flashy_Ger.NINA.Platesolveplus.PlatesolveplusDrivers {
    /// <summary>
    ...
    public internal class PlatesolveplusWeatherProvider : IEquipmentProvider<IWeatherData> {
    private IProfileService profileService;

    [ImportingConstructor]
    public PlatesolveplusWeatherProvider(IProfileService profileService) {
        this.profileService = profileService;
    }

    public string Name => "Platesolveplus";

    public IList<IWeatherData> GetEquipment() {
        var devices = new List<IWeatherData>();
        devices.Add(new PlatesolveplusWeatherDriver("MyUniqueId", "MyDeviceId"));
